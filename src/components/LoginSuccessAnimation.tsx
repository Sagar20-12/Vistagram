      ...
      `}>
        ...
        <div className="flex justify-center mb-4">
          ...
          `}>
            ...
            <Sparkles className="absolute -bottom-2 -left-2 w-5 h-5 text-blue-400 animate-sparkle" style={{ animationDelay: '0.5s' }} />
        ...
        <div className="text-center space-y-2">
          ...
          <p className={`
            ...
            ${animationPhase === 'visible' ? 'translate-y-0 opacity-100 animate-slide-up' : 'translate-y-4 opacity-0'}
          `}>
            You're all set to start sharing your moments
          </p>
        </div>
        ...
        <div className="mt-6 w-full bg-gray-200 rounded-full h-1 overflow-hidden">
          <div className={`
            h-full bg-gradient-to-r from-green-400 to-blue-500 rounded-full transition-all duration-2000 ease-linear
